...
<body class="theme-color-1">
        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home  text-center">
                    <img src="{{asset('images/donner.jpg')}}" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                                    <div>
                                        <h4>Bienvenue sur Tout Partager </h4>
                                        <h1>Don des objets</h1>
                                        <a href="#" class="btn btn-solid">Voir plus </a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div>
                <div class="home text-center">
                    <img src="{{asset('images/dn.jpg')}}" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
            ...
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="{{asset('images/12.jpg')}}" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                ...
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="{{asset('images/13.jpg')}}" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
    ...
    <div class="title1 section-t-space">
        <h4>Don des objets </h4>
        <h2 class="title-inner1">Déposer votre objet</h2>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="product-para">
                    <p class="text-center">Avec cet formulaire vous pouvez déposer votre objet afin d'aider plusieurs personnes qui ont besoin de votre aide ! MERCI BEAUCOUP.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="contact-page section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <form class="theme-form" method="POST" action="{{ route('produit.store') }}"  enctype="multipart/form-data">
                        @csrf
                        <fieldset>
                        <div class="form-row row">
                            <div class="col-md-6">
                                <label for="name">Nom d'objet</label>
                                <input type="text" class="form-control" id="nom" name="nom" placeholder="Enter Your name"
                                    required="">
                            </div>
                            <div class="col-md-6">
                                <label for="email">Poids</label>
                                <input type="text" class="form-control" id="poids" name="poids" placeholder="Email" required="">
                            </div>
                            <div class="form-group row">
                                <label for="exampleFormControlSelect1" class="col-xl-3 col-sm-4 mb-0">Select categorie :</label>
                                <select class="form-control digits col-xl-8 col-sm-7" id="exampleFormControlSelect1" name="categorie_id">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nomc" name="nomc" placeholder="Email" required="">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="telephone" name="telephone" placeholder="Email" required="">
                            </div>
                            <div class="col-md-12">
                                <label for="review">Description</label>
                                <textarea class="form-control" placeholder="Write Your Message"
                                    id="description" name="description" rows="6"></textarea>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <button id="submit" name="submit" class="btn btn-solid">Déposer votre objet</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <!-- Tab product -->
    <div class="title1 section-t-space">
        <h4>Contactez nous pour plus des infos</h4>
        <h2 class="title-inner1"> Objets à donner :</h2>
    </div>
                                ...
                                <div class="no-slider row">
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{ URL::to('/') }}/images/{{ $produit->image ?? ''}}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{ URL::to('/') }}/images/{{ $produit->image2 ?? ''}}"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <h4>Tel : {{$produit->telephone}}</h4><br/>
                ...
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>Envoi gratuit dans la tunisie</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 service-block">
