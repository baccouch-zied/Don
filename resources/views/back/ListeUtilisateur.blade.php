                                ...
                                @foreach($utilisateurs as $utilisateur)
                                    ...
                                    <td>
                                        <form method="POST" action="{{ route('utilisateur.update',$utilisateur->id) }}">
                                            @csrf
                                            @method('PUT')
                                        <button type="submit" class="btn waves-effect waves-light btn-warning">Valider compte</i></button>
                                    </form>
                                        <form action="{{route("utilisateur.destroy",$utilisateur->id)}}" method="POST" onsubmit="return confirm('Vous etes sure de Supprimer Cette compte ?');" style="display: inline-block;">
