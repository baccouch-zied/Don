                        ...
                        <div class="card o-hidden  widget-cards">
                            <div class="bg-secondary card-body">
                                <div class="media static-top-widget row">
                                    ...
                                    <div class="media-body col-8"><span class="m-0">Objets</span>
                                        <h3 class="mb-0"> {{$produit->count()}} Objets</small></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-warning card-body">
                                <div class="media static-top-widget row">
                                    ...
                                    <div class="media-body col-8"><span class="m-0">Messages</span>
                                        <h3 class="mb-0"> {{$contact->count()}} Messages</small></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card o-hidden widget-cards">
                            <div class="bg-primary card-body">
                                <div class="media static-top-widget row">
                                    ...
                                    <div class="media-body col-8"><span class="m-0">Utilisateurs</span>
                                        <h3 class="mb-0"> {{$user->count()}} Utilisateurs</small></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
