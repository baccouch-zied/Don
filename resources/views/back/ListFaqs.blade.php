                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @foreach($faqs as $faq)
                                    ...
                                    <td>{{$faq->reponse}}</td>
                                    <td>
                                        <a href="{{route("faq.edit",$faq->id)}}" class="btn waves-effect waves-light btn-warning"><i class="fa fa-pencil"></i></a>
                                        <form action="{{route("faq.destroy",$faq->id)}}" method="POST" onsubmit="return confirm('Vous etes sure de Supprimer Cette compte ?');" style="display: inline-block;">
